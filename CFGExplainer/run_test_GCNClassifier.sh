...
declare -a path="AFCGs_poison"                         ## path="data_testing"              ## path="Partition_Trigger_samples"
declare -a hiddens="1024-512-128"                           ## hiddens="1024-512-128"
declare -a lr="0.0001"
declare -a model_name="06-15_19:40:42-GCNClassifier_"       ## model_name="GCNClassifier_"      ## model_name="05-11_13:04:22-GCNClassifier_"
